...
(function($, window, document) {
    var pluginName = 'selectlist_default',
        defaults = {
...
//                'max-height': that.setStyleProperty(that.settings.optionHeight * that.settings.optionNumCount + 10) + that.settings.optionHeight / 2 + 'px',
        ...
        renderSelect: function(element) {
            ...
            if (that.settings.reg == true) {
                selectHTML = '<div tabindex="1"  id="' + selectID + '" class="select-wrapper ' + selectClassName + '"><input type="hidden" name="' + selectName + '" value="" /><i class="icon select-down"></i><input type="button" class="select-button" value=""/><div class="select-list"><div class="default_name" >请选择</div><ul>';
            } else {
                selectHTML = '<div id="' + selectID + '" class="select-wrapper ' + selectClassName + '"><input type="hidden" name="' + selectName + '" value="" /><i class="icon select-down"></i><input type="button" class="select-button" value=""/><div class="select-list"><div class="default_name" >请选择</div><ul>';
            }
            for (var i = 0; i < selectLength; i++) {
