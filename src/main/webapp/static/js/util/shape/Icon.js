...
define(function (require) {
    ...
    function _iconimages(ctx, style, refreshNextFrame) {
        var imagesShape = require('zrender/shape/images');
        this._imagesShape = this._imagesShape || new imagesShape({
            style: {}
        });
        for (var name in style) {
            this._imagesShape.style[name] = style[name];
        }
        this._imagesShape.brush(ctx, false, refreshNextFrame);
    }
    ...
    Icon.prototype =  {
        ...
        brush: function (ctx, isHighlight, refreshNextFrame) {
            ...
            if (iconType === 'images') {
                var imagesShape = require('zrender/shape/images');
                imagesShape.prototype.brush.call(this, ctx, isHighlight, refreshNextFrame);
