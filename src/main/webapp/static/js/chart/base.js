...
define(function (require) {
    ...
    Base.prototype = {
        ...
        getSymbolShape: function (
            ...
            if (symbol.match('images')) {
                itemShape.style.images = symbol.replace(new RegExp('^images:\\/\\/'), '');
                itemShape = new imagesShape({
        ...
        addMark: function (seriesIndex, markData, markType) {
            ...
            if (this.selectedMap[serie.name]) {
                ...
                if (this.option.animation && !this.option.renderAsimages) {
