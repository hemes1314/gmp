...
@XmlRootElement(name = "ZHR_ORGEH_MD.Response")
public class ZHRORGEHMDResponse {

    @XmlElement(name = "JYID", required = true)
    protected String jyid;
    @XmlElement(name = "IT_OUT", required = true)
    protected ZHRORGEHMDResponse.ITOUT itout;
     ...
     * @return
     *     possible object is
     *     {@link ZHRORGEHMDResponse.ITOUT }
     *     
     */
    public ZHRORGEHMDResponse.ITOUT getITOUT() {
        return itout;
    }
     ...
     *     
     */
    public void setITOUT(ZHRORGEHMDResponse.ITOUT value) {
        this.itout = value;
    }
