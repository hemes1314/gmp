...
public class Dialect {
     ...
     */
    public String getLimitString(String sql, int offset, int limit,String sortOrder,String sortField) {
    	return getLimitString(sql,offset,Integer.toString(offset),limit,Integer.toString(limit),sortOrder,sortField);
    }
